...
import {setProductId} from "../../../features/orders/slice/sharedOrderUiSlice";


export const FormMultiColumnComboBoxVirtualSalesProduct = (fieldRenderProps: FieldRenderProps) => {
    const {
        validationMessage,
        touched,
        onFocus,
    ...
    const columns = [
        ...
        {field: "quantityOnHandTotal", header: "QOH", width: "70px"},
        {field: "availableToPromiseTotal", header: "ATP", width: "7px"},
        {field: "price", header: "Price", width: "70px"},
        {field: "listPrice", header: "ListPrice", width: "0px"},
    ];

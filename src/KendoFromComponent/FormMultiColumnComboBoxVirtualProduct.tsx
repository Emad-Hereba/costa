...
export const FormMultiColumnComboBoxVirtualFacilityProduct = (
    ...
    const columns = [{field: "productName", header: "Product", width: "200px"}];
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Products.getProductsLov(params).then((json) => {
            if (json) {

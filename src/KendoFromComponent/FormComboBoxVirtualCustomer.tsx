...
import {setCustomerId} from "../../../features/orders/slice/sharedOrderUiSlice";


export const FormComboBoxVirtualCustomer = (fieldRenderProps: FieldRenderProps) => {
    const {
        validationMessage,
        touched,
        onFocus,
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Parties.getCustomersLov(params)
            .then((json) => {
                if (json) {

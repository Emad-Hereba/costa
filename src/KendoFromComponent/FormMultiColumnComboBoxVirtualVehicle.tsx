...
export const FormMultiColumnComboBoxVirtualVehicle = (fieldRenderProps: FieldRenderProps) => {
    ...
    const columns = [
        ...
        {field: "makeDescription", header: "Make", width: "200px"},
        {field: "modelDescription", header: "Model", width: "200px"},
        {field: "fromPartyName", header: "Customer", width: "200px"},
        {field: "serviceDate", header: "Last Service", width: "200px"},
    ];

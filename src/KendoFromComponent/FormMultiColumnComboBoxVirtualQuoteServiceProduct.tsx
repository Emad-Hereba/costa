...
import {setProductId, setSelectedProduct} from "../../../features/services/slice/quoteUiSlice";

export const FormMultiColumnComboBoxVirtualQuoteServiceProduct = (
    ...
    const columns = [
        ...
        {field: "facilityName", header: "Facility", width: "200px"},
        {field: "quantityOnHandTotal", header: "QOH", width: "200px"},
        {field: "availableToPromiseTotal", header: "ATP", width: "200px"},
    ...
    const requestData = React.useCallback((skip: number, filter: string) => {
        ...
        agent.Products.getJobQuoteProductsLov(params).then((json) => {
            if (json) {
    ...
    const onChangeHandler = React.useCallback(
        (event) => {
            if (event.value === null) {
                ...
                dispatch(setProductId(event.value.productId));
                dispatch(setSelectedProduct(event.value));
            }
